...
const mockDataAPI = {
  ...
  subtitle: '',
  text: `O Krav Maga é uma tecnica de defesa, conhecida por sua eficiência em situações de autodefesa e combate corpo a corpo. Criado por Imi Lichtenfeld nas décadas de 1930 e 1940, o Krav Maga foi inicialmente concebido como um sistema de defesa pessoal para os judeus que enfrentavam a perseguição na Europa.
